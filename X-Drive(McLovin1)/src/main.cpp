...
brain Brain;
vex::motor      RightRear(vex::PORT15, vex::gearSetting::ratio18_1, true);
vex::motor      LeftRear(vex::PORT14, vex::gearSetting::ratio18_1, true);
vex::motor      RightFront(vex::PORT12, vex::gearSetting::ratio18_1, true);
vex::motor      LeftFront(vex::PORT13, vex::gearSetting::ratio18_1, true);
vex::motor      intake_motor(vex::PORT18, vex::gearSetting::ratio18_1, true);
vex::motor      catapult_motor(vex::PORT16, vex::gearSetting::ratio36_1, true);
vex::motor      catapult_motor1(vex::PORT11, vex::gearSetting::ratio36_1, false);
vex::motor      Roller_motor(vex::PORT17, vex::gearSetting::ratio36_1, true);

vex::controller Controller1(vex::controllerType::primary);

limit catl = limit(Brain.ThreeWirePort.H);
pneumatics expand = pneumatics(Brain.ThreeWirePort.G);
void driveM();
void catload();
bool loaded;
...
void autonomous(void) {
  ...
  RightRear.rotateFor(directionType::rev, -0.25, rotationUnits::rev, 100, velocityUnits::pct);

  wait(250,msec);

  Roller_motor.rotateFor(directionType::rev, 0.1, rotationUnits::rev, 100, velocityUnits::pct);
...
void usercontrol(void) {
  ...
  if((abs(a3) > 960) || (abs(a4) > 960) || (abs(a1) > 960)){
    RightFront.spin(reverse, a3 - a4 - a1, voltageUnits::mV);
    LeftFront.spin(reverse, -a3 - a4 - a1, voltageUnits::mV);
    RightRear.spin(reverse, a3 + a4 - a1, voltageUnits::mV);
    LeftRear.spin(reverse, -a3 + a4 - a1, voltageUnits::mV);
  } else {
